...
dense waypoint sweeps around the jaw, the inverse kinematics is used in a modified fashion. First, the damped least-squares solution (PyBullet
\code{IK\_DLS}) is only a starting point: starting from a seeding joint configuration, the solver iterates up to ten times, computing the tool position
