...
\usepackage{xltabular} % Longtable + tabularx (page-breaking full-width tables)
...
\quad Pascal Meißner \quad Frank Deinzer
}
\IEEEauthorblockA{
...
\{\thwsemaillocal{pascal.meissner} \textbar~\thwsemaillocal{frank.deinzer}\}@\thwsemaildomain\\
...
\begin{abstract}
    \input{subpapers/00_abstract}
\end{abstract}

\begin{IEEEkeywords}
    UR5e, Simulation, Stereo Reconstruction, 3D Registration, Qt
\end{IEEEkeywords}
...
\input{subpapers/01_manuel_stoeth}
\chapterbreak

\section{Image Acquisition and 3D Reconstruction}
\sectionauthors{Sebastian Nagles}
\input{subpapers/02_sebastian_nagles}
\chapterbreak

\section{ 3-D Registration and Model Construction}
\sectionauthors{Marvin Kraus}
\input{subpapers/03_marvin_kraus}
\chapterbreak

\section{Medical Touchscreen Graphical User Interface Integration}
\sectionauthors{Irmak Damla Özdemir}
\input{subpapers/04_irmak_damla_oezdemir}
\chapterbreak
